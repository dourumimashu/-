    ...
    <div class="layuimini-main">
        ...
        <script type="text/html" id="toolbarDemo">
            <div class="layui-btn-container">
                <button class="layui-btn layui-btn-normal layui-btn-sm data-add-btn" lay-event="add"> 查询详细 </button>
        ...
        <script type="text/html" id="currentTableBar">
            <a class="layui-btn layui-btn-normal layui-btn-xs data-count-edit" lay-event="query">更新公告</a>
        ...
        table.on('tool(currentTableFilter)', function (obj) {
            ...
            if (obj.event === 'query') {  // 监听查询详情操作
                var index = layer.open({
                    ...
                    shadeClose: true,
                    area: ['60%', '60%'],
                    content: '/queryNoticeById?id='+data.id,
                });
