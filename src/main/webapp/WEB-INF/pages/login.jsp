...
<head>
    ...
    <script type="text/javascript" src="/library/lib/jquery-3.4.1/jquery-3.4.1.min.js"></script>
    ...
    <style>
        ...
        body {background: url("${pageContext.request.contextPath}/library/images/loginbg.png") no-repeat center;}
