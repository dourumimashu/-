...
<div class="layui-form layuimini-form">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="oldPwd" lay-verify="required" lay-reqtext="旧密码不能为空" class="layui-input" value="${admin.password}" disabled="disabled">
        </div>
    </div>
    ...
    layui.use(['form'], function () {
        ...
        form.on('submit(saveBtn)', function (data) {
            ...
            if (datas.newPwd != datas.newPwdAgain){
                ...
                //向后台发送数据提交添加
                if (datas.oldPwd == datas.newPwd) {
                    layer.msg("新密码和旧密码不能一致")
                } else {
                    $.ajax({
                        url: "/updatePwdSubmit",
                        type: "POST",
